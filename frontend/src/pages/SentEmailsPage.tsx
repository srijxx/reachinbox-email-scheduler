...
export function SentEmailsPage() {
  const { data, loading, error, fetch } = useSentEmails();
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-gray-100">Sent Emails</h1>
          <p className="text-sm text-gray-500 mt-0.5">
            {data ? `${data.total} emails delivered` : 'Loading…'}
          </p>
        </div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
        {loading && !data ? (
          ...
          <EmptyState
            ...
            description="Once your scheduled jobs execute, emails will appear here with Ethereal preview links."
            icon={
          ...
          <>
            <EmailTable emails={data.data} type="sent" />
            <Pagination
              page={page}
